% [Xval,Fval,Jval,iterations,flag] = Newton_Raphson_for_Multifunction(Fun,X0,xtol,spc,ftol,count,A,maxit,varargin) 
% [f,J,outpara] = Ball_balance(x0,delta,k,N,Speed)
